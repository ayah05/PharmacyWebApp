...
<form method="POST" action="">
    ...
    <input type="checkbox" name="weekDays[]" value="Monday" id="weekDays"> Monday  <input type="number" min="0" max="9" name="morning_mo" value="morning"> - <input type="number" name="noon_mo" value="noon" min="0" max="9" id="dose"> - <input type="number" min="0" max="9" name="evening_mo" value="evening"> - <input type="number" min="0" max="9" name="night_mo" value="night"> <br> <!--you need to change all inputs to numbers and change field size + disable them until box checked-->
    <input type="checkbox" name="weekDays[]" value="Tuesday" id="weekDays"> Tuesday  <input type="number" min="0" max="9"  name="morning_tue" value="morning" > - <input type="number" name="noon_tue" value="noon" min="0" max="9" id="dose"> - <input type="number" min="0" max="9" name="evening_tue" value="evening"> - <input type="number" min="0" max="9" name="night_tue" value="night"> <br>
    <input type="checkbox" name="weekDays[]" value="Wednesday" id="weekDays"> Wednesday   <input type="number" min="0" max="9"  name="morning_tue" value="morning" > - <input type="number" name="noon_tue" value="noon" min="0" max="9" id="dose"> - <input type="number" min="0" max="9" name="evening_tue" value="evening"> - <input type="number" min="0" max="9" name="night_tue" value="night"> <br>
    <input type="checkbox" name="weekDays[]" value="Thursday" id="weekDays"> Thursday  <input type="number" min="0" max="9"  name="morning_tue" value="morning" > - <input type="number" name="noon_tue" value="noon" min="0" max="9" id="dose"> - <input type="number" min="0" max="9" name="evening_tue" value="evening"> - <input type="number" min="0" max="9" name="night_tue" value="night"> <br>
    <input type="checkbox" name="weekDays[]" value="Friday" id="weekDays"> Friday   <input type="number min="0" max="9" name="morning_tue" value="morning" > - <input type="number" name="noon_tue" value="noon" min="0" max="9" id="dose"> - <input type="number" min="0" max="9" name="evening_tue" value="evening"> - <input type="number" min="0" max="9" name="night_tue" value="night"> <br>
    <input type="checkbox" name="weekDays[]" value="Saturday" id="weekDays"> Saturday  <input type="number" min="0" max="9"  name="morning_tue" value="morning" > - <input type="number" name="noon_tue" value="noon" min="0" max="9" id="dose"> - <input type="number" min="0" max="9" name="evening_tue" value="evening"> - <input type="number" min="0" max="9" name="night_tue" value="night"> <br>
    <input type="checkbox" name="weekDays[]" value="Sunday" id="weekDays"> Sunday   <input type="number" min="0" max="9"  name="morning_tue" value="morning" > - <input type="number" name="noon_tue" value="noon" min="0" max="9" id="dose"> - <input type="number" min="0" max="9" name="evening_tue" value="evening"> - <input type="number" min="0" max="9" name="night_tue" value="night"> <br>
